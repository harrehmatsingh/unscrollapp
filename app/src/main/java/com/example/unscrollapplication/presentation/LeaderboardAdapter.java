...
public class LeaderboardAdapter extends RecyclerView.Adapter<LeaderboardAdapter.ViewHolder> {
    ...
    private final List<LeaderboardActivity.LeaderboardItem> items = new ArrayList<>();
    private String selfUid;

    public void setItems(List<LeaderboardActivity.LeaderboardItem> newItems, String selfUid) {
        items.clear();
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        LeaderboardActivity.LeaderboardItem item = items.get(position);
        int rank = position + 1;
